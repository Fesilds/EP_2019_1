...
livro_calculo = False
kit_bixo = False
livro_calculo_vet = False
kit_bixo_vet = False
if livro_calculo == True:
    nome['ataque']+=3
elif kit_bixo == True:
    nome['ataque']+= 5
    nome['vida']+= 5
elif livro_calculo_vet == True:
    nome['ataque']+=3
elif livro_calculo_vet == True:
    nome['ataque']+= 5
    nome['vida']+= 5
...
if veterano['vida'] <= 0:
    if ((a/3) == 0):
        inventario_nome.append("livro de cálculo vet")
        livro_calculo_vet = True
    elif a == 10:
        inventario_nome.append("Kit Bixo vet")
        kit_bixo_vet = True
veteranow = {}
veteranow['vida'] = 20
veteranow['ataque'] = 5
inventario_do_veteranow = []
a = random.randint(1,20)
if veteranow['vida'] <= 0:
    if ((a%3) == 0):
        inventario_nome.append("livro de cálculo vet")
...
print("---------------")
print("Voce esta na porta ")
print("de entrada do Insper")
chave_armario = False
EP = False
while game_on == True and game_win == False:
    opcoes = input("Deseja entrar?")
    if opcoes == "Não" or opcoes == "Casa" or opcoes == "Nao":
        print("Você destravou o final secreto:")
        print("-------------------------------")
        print("Sua preguiça de fazer o EP é tão")
        print("grande que dobra a realidade e adia")
        print("o EP para o proximo mes. Vai pra casa")
        game_win = True
    if opcoes == "Inventario":
        if len(inventario_nome) == 0:
            print("seu invetário está vazio")
            opcoes = input("Aonde estava?")
        elif len(inventario_nome) > 0:
            print("Inventario")
            print("----------")
            print(inventario_nome)
            print("----------")
            opcoes = input("Em qual andar estava?")    
    if opcoes == "Saguao" or opcoes == "Sim":
            print("Saguao")
            print("------")
            print("Voce entrou no Insper e esta no saguao,"
                  "e ve a Biblioteca e o Elevador." )
            opcoes = input("Para onde deseja ir?")
    if opcoes == "Biblioteca":
        print("Biblioteca")
        print("----------")
        print("Voce chegou a Biblioteca do Insper ")
        print("lá você pode procurar por um livro")
        print("para saber mais sobre o EP, ir para")
        print("um aquario tentar fazer o EP ou voltar")
        print("para o Saguao,")
        opcoes = input("Para onde deseja ir: Procurar um livro,"
                       "Aquario, ou Elevador?")
    if opcoes == "Inventario":
        if len(inventario_nome) == 0:
            print("seu invetário está vazio")
    ...
    if opcoes == "Elevador":
        opcoes = input("Você entrou no elevador, para qual andar deseja ir:"
              "1 andar/ 2 andar/ 3 andar/ 4 andar / Saguao?")
    if opcoes == "Saguao" or opcoes == "Sim":
            print("Saguao")
            print("------")
            print("Voce entrou no Insper e esta no saguao,"
    ...
    if opcoes == "1 andar":
        ...
        print("subido um andar de elevador, e te atacou.")
        while veterano['vida'] > 0 and nome['vida'] > 0:
            ...
            if veterano['vida'] == 0:
                 ...
                 opcoes = input("Para onde deseja ir: Elevador?")    
            elif nome['vida'] == 0:
                game_on = False
    if opcoes == "Elevador":
        opcoes = input("Você entrou no elevador, para qual andar deseja ir:"
    ...
    if opcoes == "2 andar":
        ...
        opcoes = input("Para aonde deseja ir: Help-Desk, Armario ou voltar"
                       "ao Elevador?")
    if opcoes == "Armario":
        print("Armario")
        print("-------")
    ...
    if opcoes == "Aquario":
        print("Aquario")
        print("-------")
        print("Voce encontrou sua chave do armario")
        inventario_nome.append("chave do armario")
        chave_armario = True
        opcoes = input("Para onde deseja ir: Procurar um livro,"
                       "Inventario ou Elevador?")
    ...
    if opcoes == "Procurar um livro":
        ...
        print("e guarda no seu inventario para te ajudar futuramente")
        livro_calculo = True
        inventario_nome.append("livro de calculo")
        opcoes = input("Para aonde deseja ir:,"
                       "Aquario, ou Elevador?")
    if opcoes == "Inventario":
        if len(inventario_nome) == 0:
    ...
    if opcoes == "Armario":
        ...
        if chave_armario == True:
                ...
                print("Não importa a força que faça, não consegue abrir o armario")
                print("sem a chave, ela esta perdida pelo Insper, vá encontra-la!")
        opcoes = input("Para aonde deseja ir: Help-Desk, Inventario ou Elevador?")
        if opcoes == "Inventario":
            if len(inventario_nome) == 0:
                print("seu invetário está vazio")
                opcoes = input("Aonde estava?")
    ...
    if opcoes == "Sala 301":
        ...
        EP = True
        opcoes = input("Para aonde deseja ir: 3 andar, Inventario ou Elevador?")
        if opcoes == "Inventario":
            if len(inventario_nome) == 0:
                print("seu invetário está vazio")
                opcoes = input("Aonde estava?")
    ...
    if opcoes == "Elevador":
        opcoes = input("Você entrou no elevador, para qual andar deseja ir:"
              "1 andar/ 2 andar/ 3 andar/ 4 andar/ sair do elevador ?")
    if opcoes == "4 andar":
        print("4 andar")
        print("------")
    ...
    if opcoes == "Wii":
        ...
        while veteranow['vida'] > 0 and nome['vida'] > 0:
                veteranow['vida'] = veteranow['vida'] - nome['ataque']
                nome['vida'] = nome['vida'] - veteranow['ataque']
                if veteranow['vida'] == 0:
                    print("Você ganhou do veterano!")
